  ...
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column label="操作" width="200" align="center">
        <template slot-scope="scope">
          <router-link :to="'/power/role/distribution/'+scope.row.id">
            <el-button type="info" size="mini" icon="el-icon-info" v-if="hasPerm('role.power')"></el-button>
          </router-link>
          <router-link :to="'/power/role/update/'+scope.row.id">
...
<script>
import roleApi from '@/api/power/role'
...
export default {
  ...
  methods: {
    ...
    addUser(){
      this.$router.push({ path: '/power/role/add' })
    },
