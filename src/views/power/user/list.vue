  ...
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column label="操作" width="230" align="center">
        <template slot-scope="scope">
          <router-link :to="'/power/user/role/'+scope.row.id">
            <el-button type="info" size="mini" icon="el-icon-info" v-if="hasPerm('user.assgin')"></el-button>
          </router-link>
          <router-link :to="'/power/user/update/'+scope.row.id">
...
<script>
import user from '@/api/power/user'
...
export default {
  ...
  methods: {
    ...
    addUser(){
      this.$router.push({ path: '/power/user/add' })
    },
